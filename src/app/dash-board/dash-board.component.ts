...
export class DashBoardComponent {
  ...
  userID :string ="qfHeZPV1xYRDf9mZa8rCvSXKYro2";
  ...
  getOICStationLocation() {
    ...
    this.afAuth.authState.subscribe((user) => {
      if (user) {
        ...
        // qfHeZPV1xYRDf9mZa8rCvSXKYro2

        this.db.list('HeadPolice/', ref => ref.orderByKey().startAt(this.userID).endAt(this.userID)).snapshotChanges().subscribe((snapshots) => {
